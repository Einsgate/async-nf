...
# 2M huge page size and 16384 huge pages equals 32G huge pages
# We need a lot of huge pages... for the default configuration
HUGE_PAGE_SIZE=16384

# DPDK deivce identifier
DPDK_DEVICE_ONE=05:00.0
DPDK_DEVICE_TWO=05:00.1
